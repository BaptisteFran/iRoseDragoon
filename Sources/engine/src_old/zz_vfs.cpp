...
{
	//if (real_filesystem_)
	//	ZZ_LOG("vfs:close(%s)₩n", real_filesystem_->get_path());
	bool ret = true;
...
{
	//ZZ_LOG("vfs:open_read_get_data(%s)₩n", path_in);
...
{
	//ZZ_LOG("vfs:get_mtime(%s)₩n", path_in);
