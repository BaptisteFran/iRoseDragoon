	...
	switch (ChipManufacturer) {
			...
			switch (ChipID.Family) {
				...
				case 5:
					switch (ChipID.Model) {
						...
						case 8: STORE_CLASSICAL_NAME ("P55C (0.25탆)"); break;
				...
				case 6:
					switch (ChipID.Model) {
						...
						case 3: STORE_CLASSICAL_NAME ("Pentium?II (0.28 탆)"); break;
						case 5: STORE_CLASSICAL_NAME ("Pentium?II (0.25 탆)"); break;
						case 6: STORE_CLASSICAL_NAME ("Pentium?II With On-Die L2 Cache"); break;
						case 7: STORE_CLASSICAL_NAME ("Pentium?III (0.25 탆)"); break;
						case 8: STORE_CLASSICAL_NAME ("Pentium?III (0.18 탆) With 256 KB On-Die L2 Cache "); break;
						case 0xa: STORE_CLASSICAL_NAME ("Pentium?III (0.18 탆) With 1 Or 2 MB On-Die L2 Cache "); break;
						case 0xb: STORE_CLASSICAL_NAME ("Pentium?III (0.13 탆) With 256 Or 512 KB On-Die L2 Cache "); break;
				...
				case 0xf:
					...
					switch (ChipID.ExtendedFamily) {
						case 0:
							switch (ChipID.Model) {
								case 0: STORE_CLASSICAL_NAME ("Pentium?IV (0.18 탆)"); break;
								case 1: STORE_CLASSICAL_NAME ("Pentium?IV (0.18 탆)"); break;
								case 2: STORE_CLASSICAL_NAME ("Pentium?IV (0.13 탆)"); break;
			...
			switch (ChipID.Family) {
				...
				case 5:
					switch (ChipID.Model) {
						...
						case 6: STORE_CLASSICAL_NAME ("K6 (0.30 탆)"); break;
						case 7: STORE_CLASSICAL_NAME ("K6 (0.25 탆)"); break;
						case 8: STORE_CLASSICAL_NAME ("K6-2"); break;
						case 9: STORE_CLASSICAL_NAME ("K6-III"); break;
						case 0xd: STORE_CLASSICAL_NAME ("K6-2+ or K6-III+ (0.18 탆)"); break;
						default: STORE_CLASSICAL_NAME ("Unknown 80586 family"); return false;
					}
					break;
				case 6:
					switch (ChipID.Model) {
						case 1: STORE_CLASSICAL_NAME ("Athlon?(0.25 탆)"); break;
						case 2: STORE_CLASSICAL_NAME ("Athlon?(0.18 탆)"); break;
		...
		case Rise:
			switch (ChipID.Family) {	
				case 5:
					switch (ChipID.Model) {
						case 0: STORE_CLASSICAL_NAME ("mP6 (0.25 탆)"); break;
						case 2: STORE_CLASSICAL_NAME ("mP6 (0.18 탆)"); break;
