...
public :
	...
	bool MSGR_IsUPDATE ()					{	return m_bFriendUPDATE;	}	// db ｰｻｽﾅﾇﾘｾﾟ ﾇﾏｳﾄ?

	bool MSGR_Add( CMessenger *pFriend );	// ﾄ｣ｱｸ ﾃﾟｰ｡
	
	void MSGR_Del( DWORD dwDBID );			// ﾄ｣ｱｸ ｻ霖ｦ
	void MSGR_Ban( DWORD dwDBID );			// ﾃ､ﾆﾃ ﾂﾜ
